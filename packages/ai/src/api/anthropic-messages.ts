...
type AnthropicToolResultContentBlock = Exclude<AnthropicToolResultContent, string>[number];

function convertContentBlocks(content: UserContent[]): AnthropicToolResultContent {
